	...
	System.out.println("檢舉內容:"+ rptl_content);	
		...
		if ("getOne_For_Display".equals(action)) { // 來自listAllRppr.jsp的請求
			...
			try {
				...
				RequestDispatcher failureView = request.getRequestDispatcher("/back-end/report/listAllRptl.jsp");
				failureView.forward(request, response);
			}
		}
		...
		if ("update".equals(action)) { // 來自update_emp_input.jsp的請求
			...
			System.out.println("更新的rptl_status" + rptl_status);	
				...
				String url = "/back-end/report/listAllRptl.jsp";
				...
				RequestDispatcher failureView = request
						.getRequestDispatcher("/back-end/report/listAllRptl.jsp");
				failureView.forward(request, response);
			}
		}
