...
// same side			
			if ( (pathVOfrom.getPath_fromlon() < pathVOout.getPath_fromlon()) && (pathVOto.getPath_fromlon() < pathVOout.getPath_fromlon()) || 
				 (pathVOfrom.getPath_fromlon() > pathVOout.getPath_fromlon()) && (pathVOto.getPath_fromlon() > pathVOout.getPath_fromlon())		
				  ...
				  pointx.add(pathVOfrom.getPath_fromlon().intValue());
			      pointy.add(pathVOfrom.getPath_fromlat().intValue());				
...
//--------------------------------------------------------------				      
				      ...
				      g2d.fillOval(pathVOfrom.getPath_fromlon().intValue()-radius, pathVOfrom.getPath_fromlat().intValue()-radius, diameter, diameter);

				      g2d.setStroke(new BasicStroke(5, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND));
				      g2d.setColor(Color.black);
				      g2d.drawOval(pathVOfrom.getPath_fromlon().intValue()-radius, pathVOfrom.getPath_fromlat().intValue()-radius, diameter, diameter);
