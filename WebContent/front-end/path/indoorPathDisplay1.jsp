...
<%
FlscVO flscVO = (FlscVO) request.getAttribute("flscVO");
...
<br>
		...
		Flight: <%=flscVO.getFlsc_airlinecode()%><%=flscVO.getFlsc_flno()%><br>



		登機門<%=flscVO.getFlsc_gate()%>到海關<br>
		<img src="<%= request.getContextPath() %>/front-end/path/pathImg.do?path_id=<%=pathVO1.getPath_id()%>" width="800" id="ImagePreview"><br>
		海關到行李轉盤<%=flscVO.getFlsc_bag()%><br>
