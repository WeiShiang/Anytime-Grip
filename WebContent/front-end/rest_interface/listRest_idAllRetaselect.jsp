						...
						<table class="table table-bordered table-hover table-striped">
							...
							<c:forEach var="avtbVO" items="${list_avtb}">
								...
								<tr align="center" valign="middle">
									...
									<td>
									<fmt:formatDate value="${avtbVO.avtb_date_s}" pattern="yyyy-MM-dd HH:mm"/>
								<br><fmt:formatDate value="${avtbVO.avtb_date_e}" pattern="yyyy-MM-dd HH:mm"/>
