...
<%
	WishVO wishVO = (WishVO) request.getAttribute("wishVO"); //EmpServlet.java (Concroller), 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
<html>
<head>
<title>追蹤產品修改 - update_wish_input.jsp</title></head>
...
<table border='1' cellpadding='5' cellspacing='0' width='400'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		<td>
		<h3>追蹤產品修改 - update_wish_input.jsp</h3>
...
<table border="0">
	<tr>
		...
		<td><%=wishVO.getUser_id()%></td>
	</tr>
	<tr>
		<td>產品編號:<font color=red><b>*</b></font></td>
		<td><%=wishVO.getProd_id()%></td>
	</tr>
	<tr>
...
<%-- 				<option value="${storeVO.store_id}" ${(wishVO.store_id==storeVO.store_id)?'selected':'' } >${storeVO.store_name} --%>
<%-- 			</c:forEach> --%>
<!-- 		</select></td> -->
<!-- 	</tr> -->
...
<input type="hidden" name="user_id" value="<%=wishVO.getUser_id()%>">
<input type="hidden" name="prod_id" value="<%=wishVO.getProd_id()%>">
