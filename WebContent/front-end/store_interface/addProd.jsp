...
<% } %>
	...
	<div class="callout"></div>
		...
		function magiclittlebtn4() {
			document.getElementById('prpi_name').value = '柯文哲的簽名照';
			document.getElementById('name').value = '柯文哲的簽名照';
			document.getElementById('descript').value = '柯文哲2016年，年度的最佳發言是「垃圾不分藍綠。」';
			document.getElementById('price').value = 200;
			document.getElementById('sort').value = '伴手禮';
			document.getElementById('format').value = '1份。';
			document.getElementById('brand').value = '海之霸餐廳獨賣。';
		}
		
		function magiclittlebtn5() {
			document.getElementById('name').value = '2017年世大運熊讚娃娃';
			document.getElementById('descript').value = '柯阿哲: 『我知道熊讚娃娃賣到來不及做了，台灣是一個很難預測的地方，瞬間搶售一空。』為紀念世大運推出的熊讚絨毛娃娃，一推出既銷售一空，請把握機會!';
			document.getElementById('price').value = 600;
			document.getElementById('sort').value = '伴手禮';
			document.getElementById('format').value = '禮盒包裝*1入';
			document.getElementById('brand').value = '海之霸餐廳獨賣。';
		}
