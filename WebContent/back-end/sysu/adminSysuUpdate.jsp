		...
		<c:forEach var="message" items="${errorMsgs}">
			<li>${message}</li>
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" name="sysu_passwd" value="<%= (sysuVO==null)? "" : sysuVO.getSysu_passwd()%>" class="form-control">
                            </div><br>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-1">
                    	<button class="btn btn-warning" name="action" value="updatePasswd">重設密碼</button>
                    </div>
                </div>
            </div>
