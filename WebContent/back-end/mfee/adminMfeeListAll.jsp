...
<%
    ...
    List<MfeeVO> list = mfeeSvc.getAll();
                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>所有的繳費紀錄</h3>
                            </div>
...
<!-- 												<th></th>   -->
										...
										<c:forEach var="mfeeVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
                                            <tr align='center' valign='middle' ${(mfeeVO.mfee_id==param.mfee_id) ? 'style="outline: thick solid yellow;;"':''}>
                                                <td>${mfeeVO.mfee_id}</td>
                                                
                                                <td>
                                                	
                                                	<c:if test="${userSvc.getOneUser(mfeeVO.user_id).user_type == '2'}" var="condition" scope="page" >
                                                	...
                                                	<c:if test="${userSvc.getOneUser(mfeeVO.user_id).user_type == '3'}" var="condition" scope="page" >
